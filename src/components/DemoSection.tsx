...
const demoContent: DemoContent[] = [
  ...
  },
  {
    ...
    alertMessage: "Registry Not Found: No medical license found for this account. Claims of medical expertise could not be verified.",
  },
  {
    id: "3",
    ...
    profession: "unknown",
    expectedStatus: "alert",
    alertMessage: "High Probability of Synthetic Media: AI-generated voice patterns detected. Video shows signs of deepfake manipulation.",
  },
  {
    id: "4",
